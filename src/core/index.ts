...
export { initDatabase, logMessage, getRecentMessages, getMessageById, getLastCatchup, markCatchup, getMessageCount, closeDatabase, logSummary, getUserSettingsByPlatformId } from './db.js';
